...
;(async function () {
  ...
  if (ipnsName) {
    ...
    console.log()
    console.log('Each new deployment will have a unique IPFS hash while the IPNS name will always point at the most recent deployment.')
    console.log('It is recommended that you share the IPNS link so that people always see the newest version of your app.')
  }
  console.log()
  return true
})()
